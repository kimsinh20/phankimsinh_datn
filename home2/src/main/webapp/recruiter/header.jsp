...
<link href="/adv/adcss/styles.css" rel="stylesheet">
<script src="/adv/adjavascript/bootstrap.bundle.min.js"></script>
<script src="/adv/ckeditor/ckeditor.js"></script>
<style>
.cke {
	visibility: hidden;
}
</style>
<script src="/adv/ckfinder/ckfinder.js"></script>
</head>
<body>
	<!-- ======= Header ======= -->
	<header id="header" class="header fixed-top d-flex align-items-center">
		...
		<div class="text-primary">
			<ul class="d-flex align-items-center">
				...
				<a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">Dịch vụ</a>
				</li>
					<li class="nav-item d-sm-block d-none me-2">
				<a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">Về chúng tôi</a>
				</li>
					<li class="nav-item d-sm-block d-none me-2">
				<a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">Liên hệ</a>
				</li>
			</ul>
		</div>
		<!-- End Search Bar -->
			...
			<ul class="d-flex align-items-center">
					...
					<ul
						...
						<li class="dropdown-header">You have 3 new messages<a
							href="#"><span class="badge rounded-pill bg-primary p-2 ms-2">View
									all</span></a></li>
						<li><hr class="dropdown-divider"></li>
						<li class="message-item"><a href="#"><img src="#" alt=""
				...
				<!-- End Profile Iamge Icon -->
					<ul
						...
						<li class="dropdown-header"><h6>Mikado</h6>
							<span>admin</span></li>
						<li><hr class="dropdown-divider"></li>
						...
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item d-flex align-items-center"
							href="/adv/user/logout"><i class="bi bi-box-arrow-right"></i><span>Sign
									Out</span></a></li>
					</ul>
