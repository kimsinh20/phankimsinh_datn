...
<main id="main pt-24" class="bg-slate-50">
	<div class="container">
				...
				<ol
					...
					<li aria-current="page">
						<div class="flex items-center">
							...
							<span
								class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">chi tiết</span>
						</div>
					</li>
				</ol>
			</nav>
	  ...
	  <div class="grid md:grid-cols-12 grid-cols-1 mt-6 gap-[30px]">
				...
				<h5 class="text-md mt-6 font-semibold py-3 bg-linear rounded-t-lg shadow-lg text-white px-3">Mô tả công việc</h5>
                ...
                <div class="lg:col-span-4 md:col-span-6  sticky top-20">
	                <div class="shadow-lg dark:shadow-gray-700 p-6 rounded-md bg-white dark:bg-slate-900">
	               		 ...
	               		 <a class="text-center bg-emerald-600 text-white hover:bg-blue-800 rounded px-3 py-2" href="/home/company/detail?id=${job.company.company_id}">Xem trang công ty <i class="fa-solid ms-2 fa-arrow-up-right-from-square"></i></a>
	               		 </div>
	               		
	                </div>
	                
                    <div class="shadow-lg dark:shadow-gray-700 rounded-md bg-white dark:bg-slate-900 mt-6">
                           <h5 class="text-md font-semibold py-3 bg-linear rounded-t-lg shadow-lg text-white px-3">Thông tin công việc</h5>
