...
<main id="main pt-24" class="bg-slate-50">
				...
				<div
					...
					<form id="fn_filter" method="post">
						<div class="grid grid-cols-1 gap-3">
							...
							<div>
								<label class="font-semibold">Thời gian làm việc</label>
							...
							<div>
								<label class="font-semibold">Lương</label>
								<div class="block mt-2">
									<div class="flex justify-between">
										<div class="inline-flex items-center mb-0">
											<input
	...
	<!--end container-->
	 ...
	 <div class="container mt-10" data-aos="zoom-in">
         <div class="grid md:grid-cols-12 bg-white grid-cols-1 rounded shadow items-center gap-[30px]">
