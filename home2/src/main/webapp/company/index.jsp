				...
				<ol
					...
					<li>
						<div class="flex items-center">
							...
							<a href="/home/company"
								class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">công ty</a>
						</div>
					</li>
			...
			<div class="lg:col-span-12 md:col-span-12">
				<div class="flex justify-between items-center bg-white px-4 py-2">
					...
					<select
									...
									name="f" onchange="submitForm('fn_company')"> ${viewJobs[1]}
					  </select>
					</div>
