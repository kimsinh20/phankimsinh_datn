	...
	<div class="bg-white px-0">
		<header
            ...
            <path
				...
				<div
					class="flex md:items-center justify-around  flex-col md:flex-row ">
					<a href="#"
						class="text-md md:my-0 text-center md:text-sm rounded-md bg-emerald-600 md:py-2 md:px-1 px-2 py-1 text-white shadow-sm"><i
						...
						<div id="dialog"
							...
							<div
								...
								<div
									...
									<div class="bg-white sm:p-6 sm:pb-4 h-screen">
										<div class="">
												...
												<div
													...
													<div
														...
														<div class="p-2 space-y-4 md:space-y-6 sm:p-8">
															<h1
																class="text-xl font-bold leading-tight tracking-tight text-true md:text-2xl">
																Đăng nhập tài khoản của bạn</h1>
															<form class="space-y-4 md:space-y-6" action="#">
																<div class="">
																	<label for="username"
																		class="block mb-2 text-sm font-medium text-slate-900">Tên đăng nhập</label> 
																...
																<div class="">
																	<label for="password"
																		class="block mb-2 text-sm font-medium text-slate-900">Mật khẩu</label>
																...
																<div
																	class="bg-gray-50 px-2 py-2 flex flex-col flex-col-reverse">
										
																	<button type="button" onclick="hideDialog()"
																		class="mt-3 inline-flex w-full justify-center rounded-md bg-rose-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-600 sm:w-auto">Hủy</button>
																	<button type="submit"
																		class="inline-flex mt-3 w-full justify-center rounded-md bg-rose-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-emerald-600 sm:w-auto">Đăng nhập</button>
																</div>
																<div class="flex items-center justify-between mt-3">
																	<a href="#"
																		class="text-sm font-medium text-true hover:underline dark:text-primary-500">Quên mật khẩu?</a>
																</div>
																<p
																	class="text-sm font-light text-gray-500  mt-3 dark:text-gray-400">
																	Bạn chưa có tài khoản? 
																	<a href="#"
																		class="font-medium text-primary-600 hover:underline dark:text-primary-500">Đăng ký ngay</a>
																</p>
															</form>
														</div>
													</div>
