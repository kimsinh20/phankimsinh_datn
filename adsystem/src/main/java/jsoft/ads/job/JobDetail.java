		...
		// TODO Auto-generated method stub
		  short id = jsoft.library.Utilities.getByteParam(request, "id");
	        ...
	        if (id >0) {
	        	...
	        	Quartet<JobObject, HashMap<Integer, String>,ArrayList<SkillObject>,ArrayList<UserObject>> getJobObject = jb.getJobObject(id, user);
	        ...
	        //	List<CareerObject> industries = jb.getCareerByCompany(company_field_id);
	            ...
	            Gson gson = new Gson();
	            String json = gson.toJson(getJobObject.getValue0());
