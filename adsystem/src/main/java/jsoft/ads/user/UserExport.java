...
public class UserExport extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		byte pageSize = 100;
		Quartet<UserObject, Integer, Byte,USER_TYPE> infos = new Quartet<>(similar, 0, pageSize,USER_TYPE.ADMIN);
		Triplet<ArrayList<UserObject>, Short,ArrayList<CompanyObject>> datas = um.getUserObjects(infos, new Pair<>(USER_SOFT.ID, ORDER.ASC));
