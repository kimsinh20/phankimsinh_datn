...
//		tmp.append("<h5 class=\"card-title\">Danh sách người sử dụng</h5>\n");
	...
	public static String getUrlPagination(USER_TYPE et) {
		String url = "";
		if(et == USER_TYPE.CLIENT) {
			url = "client";
		} else if(et == USER_TYPE.RECRUITER) {
			url= "recruiter";
		} else {
			url="user";
		}
	...
	public static StringBuilder pagination(UserObject user, Short total, Byte pageSize,USER_TYPE et,int page,String saveKey,boolean trash) {
...
//
		...
		out.append("<a class=\"page-link\" href=\"/adv/"+UserLibrary.getUrlPagination(et)+"/list?page="+(page > 1 ? page - 1 : 1)+urlkey+"\" tabindex=\"-1\" aria-disabled=\"true\"><span aria-hidden=\"true\">&laquo;</span></a></a>");
		out.append("</li>");
		if(page>=4) {
		out.append("<li class=\"page-item\">");
		out.append("<a class=\"page-link\" href=\"/adv/"+UserLibrary.getUrlPagination(et)+"/list?page=1"+urlkey+"\" tabindex=\"-1\" aria-disabled=\"true\"><span aria-hidden=\"true\">1</span></a></a>");
		out.append("</li>");
		}
		//left current
		String leftCurrent = "";
		...
		for(int i=page-1;i>0;i--) {
			leftCurrent = "<li class=\"page-item\"><a class=\"page-link\" href=\"/adv/"+UserLibrary.getUrlPagination(et)+"/list?page="+i+urlkey+"\">"+i+"</a></li>"+leftCurrent;
		...
		out.append("<a class=\"page-link\" href=\"/adv/"+UserLibrary.getUrlPagination(et)+"/list?page="+page+urlkey+"\">"+page+"</a>");
		out.append("</li>");
		
		String rightCurrent ="";
		 count = 0;
		for(int i=page+1;i<=totalPage;i++) {
			rightCurrent+="<li class=\"page-item\"><a class=\"page-link\" href=\"/adv/"+UserLibrary.getUrlPagination(et)+"/list?page="+i+urlkey+"\">"+i+"</a></li>";
			if(++count>=2) {
				break;
			}
		}
...
//		out.append(" <li class=\"page-item\"><a class=\"page-link\" href=\"/adv/"+UserLibrary.getUrlPagination(user)+"/list?page="+totalPage+"\">"+totalPage+"</a></li>");
		if(page<totalPage-2) {
		out.append("<li class=\"page-item\" >");
		out.append("<a class=\"page-link\"  href=\"/adv/"+UserLibrary.getUrlPagination(et)+"/list?page="+totalPage+urlkey+"\"><span aria-hidden=\"true\">"+totalPage+"</span></a></a>");
		out.append("</li>");
		}
		out.append("<li class=\"page-item "+isNext+"\" >");
		out.append("<a class=\"page-link\"  href=\"/adv/"+UserLibrary.getUrlPagination(et)+"/list?page="+(page < totalPage ? page + 1 : totalPage)+urlkey+"\"><span aria-hidden=\"true\">&raquo;</span></a></a>");
		out.append("</li>");
		out.append("</ul>");
