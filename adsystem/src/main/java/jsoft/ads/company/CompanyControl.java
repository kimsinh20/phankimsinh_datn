...
//	---------------------------------------------
	public Quartet<CompanyObject, HashMap<Integer, String>,ArrayList<FieldObject>,ArrayList<JobObject>> getCompanyObject(short id, UserObject userLogin) {
...
//	----------------------------------------------
	...
	Quintet<ArrayList<CompanyObject>, Short,HashMap<Integer,String>,ArrayList<FieldObject>,ArrayList<CompanyObject>> datas = this.cm.getCompanyObjects(infos, so);
        ...
        views.add(CompanyLibrary.createdChart(datas.getValue4()).toString());
