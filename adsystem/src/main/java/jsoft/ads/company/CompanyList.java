...
//		 out.append("<small><i class=\"bi bi-ban-fill\"></i></small>");
		...
		out.append("<label for=\"company_tax_code\" class=\"form-label\"><i class=\"fas fa-user me-2\"></i>Mã số thuế</label>");
		out.append("<input type=\"text\" class=\"form-control\" placeholder=\"...\" name=\"company_tax_code\" id=\"company_tax_code\" required>");
		 out.append("<small><i class=\"bi bi-ban-fill\"></i></small>");
		out.append("</div>");
		out.append("</div>");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String company_tax_code =  request.getParameter("company_tax_code");
		String logo ="";
		...
		if (checkValidString(companyName) && checkValidString(email) 
            ...
            company.setCompany_tax_code(company_tax_code);
