...
import jsoft.ads.applications.APP_EDIT_TYPE;
...
public class AppDR extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null && id > 0) {
			...
			String url = "/adv/employer/apply?page=" + page;
			boolean delResult;
			if (trash == null) {
			...
			if (delResult) {
				...
				response.sendRedirect("/adv/employer/apply?err=notok");
			}
		} else {
			response.sendRedirect("/adv/employer/apply?err=nopermis");
		}
	}
