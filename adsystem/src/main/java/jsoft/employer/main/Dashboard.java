...
public class Dashboard extends HttpServlet {
	...
	protected void view(HttpServletRequest request, HttpServletResponse response, UserObject user) throws ServletException, IOException {
		...
		UserControl uc = new UserControl(cp);
		 ...
		 Quintet<Integer, Integer, Integer, ArrayList<JobObject>,HashMap<Integer, Integer>> data =  uc.getDashboardEmployer(user.getUser_id());
		 ...
		 HashMap<Integer, Integer> data_chart = data.getValue4();
		...
		out.append("<h5 class=\"card-title\">Tin tuyển dụng chờ duyệt</h5>");
		...
		out.append("<div class=\"card-body\">");
		out.append("<h5 class=\"card-title \">Tin tuyển dụng đang ứng tuyển</span></h5>");
